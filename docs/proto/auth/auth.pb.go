...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\vVerifyToken\x12\x13.auth.VerifyRequest\x1a\x14.auth.VerifyResponse\x128\n" +
	"\vHealthCheck\x12\x13.auth.HealthRequest\x1a\x14.auth.HealthResponseB\bZ\x06.;authb\x06proto3"
...
var file_proto_auth_auth_proto_goTypes = []any{
	...
	(*HealthRequest)(nil),    // 6: auth.HealthRequest
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	6, // 3: auth.AuthService.HealthCheck:input_type -> auth.HealthRequest
	...
	7, // 7: auth.AuthService.HealthCheck:output_type -> auth.HealthResponse
